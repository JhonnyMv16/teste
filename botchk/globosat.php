...
$resp ->method = 'POST';
$resp ->post = '{"payload":{"email":"'.$email.'","password":"'.$pwd.'","serviceId":4654},"captcha":""}';
$resp ->Request();
$json = json_decode($resp->data, true);

if($json['id'] === 'Authenticated'){

    $resp->url = 'https://cocoon.globo.com/v2/user/logged?servico_id=6772';
    $resp->headers = array(
        ...
        'Origin: https://globosat.globo.com',
        'Connection: keep-alive',
        'Referer: https://globosat.globo.com/'
    );
